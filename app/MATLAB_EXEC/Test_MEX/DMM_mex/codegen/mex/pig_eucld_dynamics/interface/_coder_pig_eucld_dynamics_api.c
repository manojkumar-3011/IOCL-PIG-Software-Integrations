 ...
 *
 * _coder_pig_eucld_dynamics_api.c
 *
 * Code generation for function '_coder_pig_eucld_dynamics_api'
 *
 */
...
void pig_eucld_dynamics_api(const mxArray *const prhs[4], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  pig_eucld_dynamics(&st, t, *x, *u, *params, *x_next);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*x_next);
}

/* End of code generation (_coder_pig_eucld_dynamics_api.c) */
